...
//
// Errors:
// * github.com/go-modulus/auth.ErrIdentityIsBlocked - if the identity is blocked.
// * github.com/go-modulus/auth.ErrInvalidPassword - if the password is invalid.
// * github.com/go-modulus/auth.ErrInvalidIdentity - if identity is not found in the repository.
...
//
// Errors:
// * github.com/go-modulus/auth.ErrIdentityExists - if you try to register a user for the same identity.
// * github.com/go-modulus/auth.ErrIdentityIsBlocked - if the identity exists in the storage, and it has status blocked.
